...
<body class="main-layout">
   <!-- loader  -->
   <div class="loader_bg">
      <div class="loader"><img src="assets/landing/images/loading.gif" alt="#" /></div>
   </div>
   <!-- end loader -->
   <!-- header -->
   <header>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 col-sm-6">
                     <ul class="lan">
                        <li><i class="fa fa-globe" aria-hidden="true"></i> Language : <img src="assets/landing/images/fleg.png" alt="#" /></li>
                     </ul>
                     <form action="#">
            ...
            <div class="container">
               <div class="row d_flex">
                  ...
                  <div class="col-md-4 col-sm-4 ">
                     <a class="logo" href="#"><img src="assets/landing/images/logo.png" alt="#" /></a>
                  </div>
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-5 col-lg-5">
               <div class="ban_img">
                  <figure><img src="assets/landing/images/ba_ing.png" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12 col-lg-5">
               <div class="about_img">
                  <figure><img src="assets/landing/images/about_img2.jpg" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon1.png" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon2.png" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon3.png" alt="#" />
                  <h3>DIGITAL marketing</h3>
                  <p>Lorem Ipsum is simply dummy text of the printing and1500s, </p>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon4.png" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon5.png" alt="#" />
            ...
            <div class="col-md-4 col-sm-6">
               <div id="ho_color" class="service_box">
                  <img src="assets/landing/images/service_icon6.png" alt="#" />
                  <h3>UX RESEARCH</h3>
                  <p>Lorem Ipsum is simply dummy text of the printing and1500s, </p>
               </div>
            </div>
                     ...
                     <div class="row">
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="assets/landing/images/potf1.jpg" alt="#" />
                              <div class="middle">
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="assets/landing/images/potf2.jpg" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="assets/landing/images/potf3.jpg" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                           <div class="portfolio_img">
                              <img src="assets/landing/images/potf4.jpg" alt="#" />
                              <div class="middle">
                                 <div class="text2">View More</div>
                              </div>
                           </div>
         ...
         <div class="row">
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="assets/landing/images/business_icon1.png" alt="#" /></i>
                  <h3>23</h3>
                  <p>NOMINATIONS </p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="assets/landing/images/business_icon2.png" alt="#" /></i>
                  <h3>31</h3>
                  <p>AGENCIES</p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="assets/landing/images/business_icon3.png" alt="#" /></i>
                  <h3>7</h3>
                  <p>AWARDS</p>
               </div>
            </div>
            <div class="col-md-3 col-sm-6">
               <div id="ho_color" class="business_box">
                  <i><img src="assets/landing/images/business_icon4.png" alt="#" /></i>
                  <h3>8</h3>
                  <p>Supported </p>
               </div>
            </div>
                              ...
                              <div class="row">
                                 <div class="col-md-4 col-sm-6">
                                    <div id="ho_bg" class="team_img">
                                       <img src="assets/landing/images/team1.png" alt="#" />
                                       <div class="ho_socal">
                                 ...
                                 <div class="col-md-4 col-sm-6">
                                    <div id="ho_bg" class="team_img">
                                       <img src="assets/landing/images/team2.png" alt="#" />
                                       <div class="ho_socal">
                                          <ul class="social_icont">
                                             <li> <a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                             <li> <a href="#"><i class="fa fa-twitter"></i></a></li>
                                 ...
                                 <div class="col-md-4 col-sm-6 d_none1">
                                    <div id="ho_bg" class="team_img ">
                                       <img src="assets/landing/images/team3.png" alt="#" />
                                       <div class="ho_socal">
                                          <ul class="social_icont">
                                             <li> <a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                             <li> <a href="#"><i class="fa fa-twitter"></i></a></li>
                     ...
                     <div class="row">
                        <div class="col-md-6 offset-md-3">
                           <div class="test_box">
                              ...
                              <i><img src="assets/landing/images/cos.jpg" alt="#" /></i> <span>Consectetur</span>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <footer>
      <div class="footer">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <a class="logo2" href="#"><img src="assets/landing/images/loogo2.png" alt="#" /></a>
               </div>
   ...
   <script src="assets/landing/js/jquery-3.0.0.min.js"></script>
